const sketches = import.meta.glob(
  ["../sketches/parody/*.js", "../sketches/works/*.js"],
  { eager: true },
);
import "./styles/gallery.css";

const GITHUB_BASE_URL =
  "https://github.com/sotashimozono/GenerativeArt.js/blob/main";
...
const initGallery = () => {
  ...
  Object.keys(sketches).forEach((path) => {
    ...
    const authorTag = work.author
      ? `<p class="card-author">by ${work.author}</p>`
      : "";
